...
final class RecurringTransaction {
    ...
    /// Owning loan / credit line when this rule is their payment generator
    /// (inverse declared on Loan.paymentRule / CreditLine.paymentRule, cascade).
    var loan: Loan? = nil
    var creditLine: CreditLine? = nil
