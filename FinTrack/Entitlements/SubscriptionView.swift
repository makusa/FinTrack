...
struct SubscriptionView: View {
    ...
    private var features: [FeatureRow] {
        [
            ...
            FeatureRow(name: lang["entitlement.table.budgets"], free: true, pro: true, plaid: true),
            FeatureRow(name: lang["entitlement.table.savings"], free: true, pro: true, plaid: true),
            ...
            FeatureRow(name: lang["entitlement.table.registered"], free: true, pro: true, plaid: true),
            ...
            FeatureRow(name: lang["entitlement.table.analytics"], free: true, pro: true, plaid: true),
            FeatureRow(name: lang["entitlement.table.fx"], free: true, pro: true, plaid: true),
            FeatureRow(name: lang["entitlement.table.export"], free: true, pro: true, plaid: true),
    ...
    private var tierComparisonTable: some View {
        VStack(spacing: 0) {
            ...
            HStack {
                ...
                Text("Max").font(.caption.weight(.semibold)).foregroundStyle(.teal).frame(width: 44)
            }
